...
ขอบเขต MVP คือกลุ่มเดียว สมาชิกไม่เกินประมาณ 50 คน ข้อความต่ำกว่า 1,000 ข้อความต่อวัน ใช้ TypeScript, Node.js, PostgreSQL, OpenAI Responses API และ deploy ด้วย Docker Compose บนเซิร์ฟเวอร์ส่วนตัว
